...
def main():
    ...
    #sorage- user_requests_scheduler_list
    # model = Model("Model5", "http://example.com/model1", "v1")
    # questionnaire = Questionnaire("Questionnaire1", "v1")
    # request = Request(model, questionnaire)
    ...
    #
    # # storage- agent_request_scheduler_list
    ...
    #sorage- user_requestss
    model1 = Model("Model1", "http://example.com/model1", "v1")
    model2 = Model("Model2", "http://example.com/model1", "v1")
    questionnaire = Questionnaire("Questionnaire1", "v1")
    request1 = Request(model1, questionnaire)
    request2 = Request(model2, questionnaire)
    print(s.add_user_request("shir", request1))
    print(s.add_user_request("shira", request1))
    print(s.add_user_request("shir", request2))
    print(s.get_user_request("shir"))
